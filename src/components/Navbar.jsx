...
const Navbar = () => {
  ...
  return (
    <nav className='bg-gray-950 flex justify-between items-center p-1 fixed w-full top-0 z-50 lg:p-2'>
      ...
      {/* Linkpage */}
      <div id="menu" className="hidden fixed inset-y-0 left-0 w-64 mt-4 pt-4 p-4 z-50 lg:w-auto lg:relative lg:space-x-3 lg:flex lg:mt-0">
        <button id="menu-close" className="lg:hidden mb-4 mt-4 lg:mb-0">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-menu"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>
        </button>
        <ul className='flex space-x-4'>
          <li><NavLink to="/" className='flex text-white text-lg mr-5 hover:text-red-600'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
